    ...
    fetch(URL.url + 'activity', {
      ...
      if (response.ok) {
        response.json().then(json => {
          ...
          this.setState({activityLookupLoaded: true, activityLookupData: activityLookupObj, totalps: calps, totalpt: calpt})
        ...
        <Dialog open={this.state.open} scroll={this.state.scroll} aria-labelledby="scroll-dialog-title" title="Dialog" modal={true} autoDetectWindowHeight={false} autoScrollBodyContent={false} contentStyle={{
          ...
          <DialogTitle id="scroll-dialog-title" style={{
            ...
            <div style={{
              ...
              <Typography variant="display1" gutterBottom="gutterBottom" noWrap="noWrap">
                Create New Pattern
              </Typography>
            </div>
          ...
          <DialogContent style={{
            ...
            <form onSubmit={this.handleSubmit}>
              <p style={{
                ...
                <TextField required="required" id="code" label="Pattern Name/Code" InputLabelProps={{
                    shrink: true
                  }} placeholder="E.g LT1" className={this.state.classes.textField} margin="normal" onChange={this.handleCode('code')} value={this.state.code}/>

                <TextField id="location_id" select="select" label="Location" className={this.state.classes.textField} value={this.state.location} onChange={this.handleLoc('location')} SelectProps={{
                    MenuProps: {
              ...
              <p style={{
                ...
                <TextField id="description" label="Short Description" InputLabelProps={{
                    shrink: true
                  }} placeholder="E.g LT, Internal" className={this.state.classes.textField} margin="normal" onChange={this.handleDesc('sdesc')} value={this.state.sdesc}/>
                <TextField id="mode" select="select" label="Mode" className={this.state.classes.textField} value={this.state.mode} onChange={this.handleMode('mode')} SelectProps={{
                    MenuProps: {
                      className: this.state.classes.menu
                    }
                  }} InputLabelProps={{
                    ...
                    modE.map(option => (<MenuItem key={option.value} value={option.value}>
                      {option.label}
                    </MenuItem>))
                  }
                </TextField>
              ...
              <p style={{
                ...
                <TextField id="long_description" label="Long Description" multiline="multiline" rows="3" InputLabelProps={{
                    shrink: true
                  }} placeholder="E.g Internal, Murdoch campus offering of the unit. May also be offered in other modes/teaching periods. Can be thought of as the 'primary' offering" className={this.state.classes.textFieldArea} margin="normal" onChange={this.handleDesc('ldesc')} value={this.state.ldesc}/></p>
                ...
                <TableBody>
                  {
                    this.state.frAct.map(n => {
                      ...
                      return (<TableRow className={this.state.classes.row} key={n.id}>
                        ...
                        <CustomTableCell><Switch onChange={this.handleChange(n.id)} color="primary"/></CustomTableCell>
                      </TableRow>);
                    })
                  }
                </TableBody>
              ...
              <p style={{
                ...
                <Button type="submit" variant="outlined" size="large" className={this.state.classes.button} style={{
                    color: "#0f6600"
                  }}>
                  <SaveIcon/>
                  Create
          ...
          <DialogActions style={{
              color: "#005e5e",
              background: 'linear-gradient(55deg, #fffef9  10%, #fffbf9 90%)'
            }}>
            <p style={{
                textAlign: 'center'
              }}>
