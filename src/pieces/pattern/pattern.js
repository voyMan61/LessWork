...
creatorClosed() {
  ...
  if(creatorOpen){
    ...
    return (
        ...
        { this.props.pab ? (<div></div>) : (<Button style={{position: 'absolute', color: 'white', backgroundColor: '#001489', right: 60}} variant="contained" size="large" onClick={this.handleCreator}>
                    Create new pattern
                  </Button>)}
